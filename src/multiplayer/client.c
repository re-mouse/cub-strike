...
/*   Updated: 2020/11/26 16:31:27 by hleilani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	connectserver(t_all *a)
{
	...
	(a->sockfd = socket(AF_INET, SOCK_STREAM, 0)) < 0 ? ft_throwerror("Sk r") : 0;
	...
	connect(a->sockfd, (SA*)&a->sock, sizeof(a->sock)) ? ft_throwerror("CER") : 0;
